	...
	public FragmentViewInputListener(FragmentView view)
	{
		...
		menu.addPopupMenuListener(new PopupMenuListener()
		{
			@Override public void popupMenuWillBecomeVisible(PopupMenuEvent e)
			{
				...
				associate.setEnabled(associations == null || associations.isEmpty());
				disassociate.setEnabled(associations != null && !associations.isEmpty());
				edit.setEnabled(associations != null && !associations.isEmpty());
			}
